                    ...
                    <div id="groomsmen-track"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <h3 class="text-white text-3xl font-serif">Robert Rances Madera</h3>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-ocean-900/95 to-transparent">
                                <p class="text-ocean-200 text-xs uppercase tracking-widest mb-1">Groomsmen</p>
                                <h3 class="text-white text-3xl font-serif">Johnrey Madera</h3>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-ocean-900/95 to-transparent">
                                <p class="text-ocean-200 text-xs uppercase tracking-widest mb-1">Groomsmen</p>
                                <h3 class="text-white text-3xl font-serif">Aci Madera</h3>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-ocean-900/95 to-transparent">
                                <p class="text-ocean-200 text-xs uppercase tracking-widest mb-1">Groomsmen</p>
                                <h3 class="text-white text-3xl font-serif">John Paolo Madera Manuel</h3>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                class="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-ocean-900/95 to-transparent">
                                <p class="text-ocean-200 text-xs uppercase tracking-widest mb-1">Groomsmen</p>
                                <h3 class="text-white text-3xl font-serif">Christopher Guinoo</h3>
                            </div>
                        </div>
